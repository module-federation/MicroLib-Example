...
exports.modules = {
  ...
  \*****************************************/
    ...
    /***/ (
      ...
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ validateAddress: () =>
          /* binding */ validateAddress,
        /* harmony export */
      });
      ...
      function listen() {
        ...
        return /*#__PURE__*/ (function () {
          var _ref2 = _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee4(options) {
                ...
                while (1) {
                  switch ((_context4.prev = _context4.next)) {
                    ...
                    case 5:
                      subscriptions.set(
                        arg.topic,
                        new Map().set(arg.id, subscription)
                      );
                                        ...
                                        switch (
                                          ...
                                          case 0:
                                            ...
                                            if (subscriptions.has(topic)) {
                                              subscriptions.get(topic).forEach(
                                                /*#__PURE__*/ (function () {
      ...
      function notify() {
        ...
        return /*#__PURE__*/ (function () {
          var _ref7 = _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee5(_ref6) {
              ...
              return regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                  switch ((_context5.prev = _context5.next)) {
                    case 0:
                      (model = _ref6.model),
                        (_ref6$args = _slicedToArray(_ref6.args, 2)),
                        (topic = _ref6$args[0]),
                        (message = _ref6$args[1]);
  ...
  \*******************************/
    ...
    /***/ (
      ...
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ validateAddress: () =>
          /* reexport safe */ _address_adapter__WEBPACK_IMPORTED_MODULE_0__.validateAddress,
        /* harmony export */ authorizePayment: () =>
          /* reexport safe */ _payment_adapter__WEBPACK_IMPORTED_MODULE_1__.authorizePayment,
        /* harmony export */ completePayment: () =>
          /* reexport safe */ _payment_adapter__WEBPACK_IMPORTED_MODULE_1__.completePayment,
        /* harmony export */ refundPayment: () =>
          /* reexport safe */ _payment_adapter__WEBPACK_IMPORTED_MODULE_1__.refundPayment,
        /* harmony export */ shipOrder: () =>
          /* reexport safe */ _shipping_adapter__WEBPACK_IMPORTED_MODULE_2__.shipOrder,
        /* harmony export */ trackShipment: () =>
          /* reexport safe */ _shipping_adapter__WEBPACK_IMPORTED_MODULE_2__.trackShipment,
        /* harmony export */ verifyDelivery: () =>
          /* reexport safe */ _shipping_adapter__WEBPACK_IMPORTED_MODULE_2__.verifyDelivery,
        /* harmony export */ listen: () =>
          /* reexport safe */ _event_adapter__WEBPACK_IMPORTED_MODULE_3__.listen,
        /* harmony export */ notify: () =>
          /* reexport safe */ _event_adapter__WEBPACK_IMPORTED_MODULE_3__.notify,
        /* harmony export */ pickOrder: () =>
          /* reexport safe */ _inventory_adapter__WEBPACK_IMPORTED_MODULE_4__.pickOrder,
        /* harmony export */
      });
      /* harmony import */ var _address_adapter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        /*! ./address-adapter */ "./src/adapters/address-adapter.js"
      );
      /* harmony import */ var _payment_adapter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        /*! ./payment-adapter */ "./src/adapters/payment-adapter.js"
      );
      /* harmony import */ var _shipping_adapter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        /*! ./shipping-adapter */ "./src/adapters/shipping-adapter.js"
      );
      /* harmony import */ var _event_adapter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
        /*! ./event-adapter */ "./src/adapters/event-adapter.js"
      );
      /* harmony import */ var _inventory_adapter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
        /*! ./inventory-adapter */ "./src/adapters/inventory-adapter.js"
      );
 ...
 */
  ...
  \*****************************************/
    ...
    /***/ (
      ...
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ authorizePayment: () =>
          /* binding */ authorizePayment,
        /* harmony export */ completePayment: () =>
          /* binding */ completePayment,
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch ((_context2.prev = _context2.next)) {
                    case 0:
                      (order = options.model),
                        (_options$args2 = _slicedToArray(options.args, 1)),
                        (callback = _options$args2[0]);
                      _context2.next = 3;
              ...
              return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                  switch ((_context3.prev = _context3.next)) {
                    case 0:
                      (order = options.model),
                        (_options$args3 = _slicedToArray(options.args, 1)),
                        (callback = _options$args3[0]);
                      _context3.next = 3;
  ...
  \******************************************/
    ...
    /***/ (
                ...
                while (1) {
                  switch ((_context2.prev = _context2.next)) {
                    case 0:
                      ...
                      shipOrderCallback = function _shipOrderCallback(
                        resolve,
                        reject
                      ) {
                        return /*#__PURE__*/ (function () {
      ...
      function trackShipment(service) {
        return /*#__PURE__*/ (function () {
          var _ref4 = _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee5(options) {
              var order,
                _options$args2,
                callback,
                trackShipmentCallback,
                callTrackShipment;
                ...
                while (1) {
                  switch ((_context5.prev = _context5.next)) {
                    case 0:
                      ...
                      trackShipmentCallback = function _trackShipmentCallbac(
                        resolve,
                        reject
                      ) {
                        return /*#__PURE__*/ (function () {
      ...
      function verifyDelivery(service) {
        return /*#__PURE__*/ (function () {
          var _ref8 = _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee8(options) {
              var order,
                _options$args3,
                callback,
                ...
                while (1) {
                  switch ((_context8.prev = _context8.next)) {
                    case 0:
                      ...
                      verifyDeliveryCallback = function _verifyDeliveryCallba(
                        resolve,
                        reject
                      ) {
                        return /*#__PURE__*/ (function () {
                                            ...
                                            return _context7.abrupt(
                                              ...
                                              order
                                                .listen({
                                                  ...
                                                  callback: verifyDeliveryCallback(
                                                    resolve,
                                                    reject
                                                  ),
                                                })
